#!/bin/bash
# TerrGoogle201.sh  - Incremental archive of RawData subdirectories.
# 6/29/21.	wmk.
#
#	Usage. bash TerrGoogle201
#
# Dependencies.
...
#
# Notes. TerrGoogle201.sh performs an incremental archive (tar) of the
...
# subsequent TerrGoogle201 calls. The initial archive file is named
# archive.0.tar.
...
if [ -z "$system_log" ]; then
  ...
  bash ~/sysprocs/LOGMSG "   TerrGoogle201 initiated from Make."
  echo "   TerrGoogle201 initiated."
else
  bash ~/sysprocs/LOGMSG "   TerrGoogle201 initiated from Terminal."
  echo "   TerrGoogle201 initiated."
fi
#
...
jumpto EndProc
EndProc:
notify-send "TerrGoogle201" " $1 complete."
~/sysprocs/LOGMSG "  TerrGoogle201 $P1 complete."
echo "  TerrGoogle201 $P1 complete"
# end TerrGoogle201
