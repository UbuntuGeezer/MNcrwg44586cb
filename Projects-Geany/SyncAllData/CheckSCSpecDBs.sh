#!/bin/bash
echo " ** CheckSCSpecDBs.sh out-of-date **";exit 1
echo " ** CheckSCSpecDBs.sh out-of-date **";exit 1
# CheckSCSpecDBs.sh -Check all RU /Special/<spec-db>.dbs against Terr86777.db
#	5/14/23.	wmk.
#
...
# 5/14/23.	wmk.	BLDLOG messaging added; inactive old code block removed;
...
#procbodyhere
	...
	mapsuffx=_RU.csv
	oodcount=0
	# loop checking all /SCPA-Downloads/Special/<spec-db>.db files.
