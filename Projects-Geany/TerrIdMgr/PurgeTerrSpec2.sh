...
if [ -z "$system_log" ]; then
  ...
  ~/sysprocs/LOGMSG "  PurgeTerrSpec2 - initiated from Make"
  echo "  PurgeTerrSpec2 - initiated from Make"
else
  ~/sysprocs/LOGMSG "  PurgeTerrSpec2 - initiated from Terminal"
  echo "  PurgeTerrSpec2 - initiated from Terminal"
fi 
TEMP_PATH=$HOME/temp
#	Environment vars:
if [ -z "$TODAY" ];then
...
sqlite3 < SQLTemp.sql
echo "  PurgeTerrSpec2 complete."
~/sysprocs/LOGMSG "  PurgeTerrSpec2 complete."
#end proc
