...
if [ -z "$system_log" ]; then
  ...
  ~/sysprocs/LOGMSG "  ListTerrSegs - initiated from Make"
  echo "  ListTerrSegs - initiated from Make"
else
  ~/sysprocs/LOGMSG "  ListTerrSegs - initiated from Terminal"
  echo "  ListTerrSegs - initiated from Terminal"
fi 
TEMP_PATH=$HOME/temp
#	Environment vars:
if [ -z "$TODAY" ];then
