...
echo ""  >> SQLTemp.sql
echo ".open '/home/vncwmk3/Territories/FL/SARA/86777/RawData/SCPA/SCPA-Downloads/Terr308/Terr308_SC.db'"  >> SQLTemp.sql
...
echo "WHERE (\"Account #\" LIKE '038409%'"  >> SQLTemp.sql
echo "AND (CAST(\"Account #\" AS INTEGER) >= 0384090002"  >> SQLTemp.sql
echo " AND CAST(\"Account #\" AS INTEGER) <= 0384090006)"  >> SQLTemp.sql
echo "OR  (CAST(\"Account #\" AS INTEGER) >= 0384090009"  >> SQLTemp.sql
echo " AND CAST(\"Account #\" AS INTEGER) <= 0384090012)"  >> SQLTemp.sql
echo "OR CAST(\"Account #\" AS INTEGER) = 0384090014"  >> SQLTemp.sql
echo "OR  (CAST(\"Account #\" AS INTEGER) >= 0384090080"  >> SQLTemp.sql
echo " AND CAST(\"Account #\" AS INTEGER) <= 0384090081) )"  >> SQLTemp.sql
echo "OR (\"Account #\" LIKE '038416%'"  >> SQLTemp.sql
echo "AND (CAST(\"Account #\" AS INTEGER) >= 0384160067"  >> SQLTemp.sql
echo " AND CAST(\"Account #\" AS INTEGER) <= 0384160068)"  >> SQLTemp.sql
echo "OR  (CAST(\"Account #\" AS INTEGER) >= 0384160070"  >> SQLTemp.sql
echo " AND CAST(\"Account #\" AS INTEGER) <= 0384160071)"  >> SQLTemp.sql
echo "OR  (CAST(\"Account #\" AS INTEGER) >= 0384160073"  >> SQLTemp.sql
echo " AND CAST(\"Account #\" AS INTEGER) <= 0384160076) )"  >> SQLTemp.sql
echo "OR \"situs address (property address)\" LIKE '%aquila st%'"  >> SQLTemp.sql
echo "OR \"situs address (property address)\" LIKE '%sierra st%'"  >> SQLTemp.sql
echo "OR \"situs address (property address)\" LIKE '%verona st%'"  >> SQLTemp.sql
echo "OR \"situs address (property address)\" LIKE '1208%florence st%'"  >> SQLTemp.sql
echo "--endwhere"  >> SQLTemp.sql
echo ")"  >> SQLTemp.sql
echo "INSERT INTO Raw86777"  >> SQLTemp.sql
echo "SELECT * FROM a;"  >> SQLTemp.sql
echo ""  >> SQLTemp.sql
echo "DROP TABLE IF EXISTS Terr308_TSRaw;"  >> SQLTemp.sql
echo "CREATE TABLE Terr308_TSRaw"  >> SQLTemp.sql
...
echo "--.import '/home/vncwmk3/Territories/FL/SARA/86777/RawData/SCPA/SCPA-Downloads/Terr308/Lett308_TS.csv' Terr308_TSRaw"  >> SQLTemp.sql
echo " -- above block inserted data by using territory servant...;"  >> SQLTemp.sql
echo ""  >> SQLTemp.sql
echo "WITH a AS (SELECT * FROM Raw86777)"  >> SQLTemp.sql
echo "INSERT INTO Terr308_TSRaw(AreaName,HouseNumber,Street1,"  >> SQLTemp.sql
echo "   Unit,City,State,Zip)"  >> SQLTemp.sql
echo "SELECT 'Terr308', "  >> SQLTemp.sql
...
echo "DROP TABLE IF EXISTS Terr308_SCBridge;"  >> SQLTemp.sql
echo "CREATE TABLE Terr308_SCBridge"  >> SQLTemp.sql
...
echo "WITH a AS (SELECT * FROM Raw86777)"  >> SQLTemp.sql
echo "INSERT INTO Terr308_SCBridge"  >> SQLTemp.sql
...
echo " '308',DownloadDate"  >> SQLTemp.sql
echo "FROM a;"  >> SQLTemp.sql
echo ""  >> SQLTemp.sql
...
echo "  FROM Terr308_SCBridge) )"  >> SQLTemp.sql
echo "UPDATE Terr308_SCBridge"  >> SQLTemp.sql
...
echo ".mode csv"  >> SQLTemp.sql
echo ".separator ,"  >> SQLTemp.sql
echo ".output '/home/vncwmk3/Territories/FL/SARA/86777/TerrData/Terr308/Working-Files/Terr308Hdr.csv'"  >> SQLTemp.sql
echo "SELECT * FROM db4.Territory"  >> SQLTemp.sql
echo "WHERE TerrID is '308';	"  >> SQLTemp.sql
echo ".quit"  >> SQLTemp.sql
echo "-- ** END BuildSCFromSegDefs.psq/sql;"  >> SQLTemp.sql
echo " -- import Lett308_TS.csv into Terr106_SC.db.Terr308_TSRaw;"  >> SQLTemp.sql
echo "DROP TABLE IF EXISTS Terr308_TSRaw;"  >> SQLTemp.sql
...
echo ".mode csv"  >> SQLTemp.sql
echo ".separator ,"  >> SQLTemp.sql
echo ".import '/home/vncwmk3/Territories/FL/SARA/86777/RawData/SCPA/SCPA-Downloads/Terr106/Lett308_TS.csv' Terr308_TSRaw"  >> SQLTemp.sql
echo " -- above block inserted data by using territory servant...;"  >> SQLTemp.sql
echo ""  >> SQLTemp.sql
