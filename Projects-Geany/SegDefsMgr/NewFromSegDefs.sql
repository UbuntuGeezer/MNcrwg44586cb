...
OR  "situs address (property address)" LIKE '%baycrest dr%'
OR  "situs address (property address)" LIKE '%bayside dr%'
OR ("situs address (property address)" LIKE '%bayshore dr%'
 AND CAST(SUBSTR("situs address (property address)",1, 
   INSTR("situs address (property address)",' '))AS INTEGER) >= 396
  AND CAST(SUBSTR("situs address (property address)",1,
   INSTR("situs address (property address)",' '))AS INTEGER)%2 = 0)
 OR ("situs address (property address)" LIKE '%bayshore dr%'
  AND CAST(SUBSTR("situs address (property address)",1,
   INSTR("situs address (property address)",' '))AS INTEGER) >= 301
  AND CAST(SUBSTR("situs address (property address)",1,
   INSTR("situs address (property address)",' '))AS INTEGER)%2 = 1)
 OR ("situs address (property address)" LIKE '%park lane dr%'
  AND CAST(SUBSTR("situs address (property address)",1,
   INSTR("situs address (property address)",' '))AS INTEGER) >= 300
  AND CAST(SUBSTR("situs address (property address)",1,
   INSTR("situs address (property address)",' '))AS INTEGER)%2 = 0)
 OR ("situs address (property address)" LIKE '%park blvd'
  AND CAST(SUBSTR("situs address (property address)",1,
   INSTR("situs address (property address)",' '))AS INTEGER) >= 400
  AND CAST(SUBSTR("situs address (property address)",1,
   INSTR("situs address (property address)",' '))AS INTEGER) <= 416
  AND CAST(SUBSTR("situs address (property address)",1,
   INSTR("situs address (property address)",' '))AS INTEGER)%2 = 0)
)
