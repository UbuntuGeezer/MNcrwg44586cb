...
#  files are combined into <special-db>.csv (See Notes.)
#
# Dependencies.
...
# ---------------------
# 6/15/23.	wmk.	code checked for *DWNLD_PATH.
# Legacy mods.
...
#procbodyhere env var TYPE_ is RU if needed.
 ...
 src_path=RawData/RefUSA/RefUSA-Downloads/Special
 targ_path=RawData/RefUSA/RefUSA-Downloads/Special
 file_suffx=_RU
