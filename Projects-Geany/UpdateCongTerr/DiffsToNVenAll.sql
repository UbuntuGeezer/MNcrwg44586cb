...
-- *			 db15.SCPA_05-26.db eliminated from queries.
-- *
...
-- *		Diff0526 - table of differences new/updated SCPA records
...
-- * 6/26/21.	wmk.	multihost code co05ented; ensure proper refs
-- * 					to Diff field names.
-- * 11/3/21.	wmk.	total rewrite.
-- * 12/3/21.	wmk.	DiffAcct field corrected to PropID.
-- * 2/9/22.	wmk.	DelFlag test bug fix; NVenAll qualified with db2;
