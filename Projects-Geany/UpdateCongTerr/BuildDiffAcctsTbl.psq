-- * BuildDiffAcctsTbl.psq/sql - Build DiffAccts table in SCPADiff_mm-dd.db;
-- *	4/26/23.	wmk.
-- *
-- * Modification History.
-- * ---------------------
-- * 4/26/23.	wmk.	code added to set territory ID 998 in all DiffAccts
-- *			 records having a residential use code, but no territory;
-- *			 comments tidied.
-- * 4/30/23.	wmk.	code added to set territory IDs in "no territory"
...
-- * Extracts all Property IDs from Diffmmdd into DiffAccts
