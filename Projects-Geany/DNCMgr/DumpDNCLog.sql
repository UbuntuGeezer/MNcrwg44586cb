-- * DumpDNCLog.sql - Dump DNCLog table to DNCLog.csv for spreadsheet.
-- *	6/12/23.	wmk.
-- *
...
-- * ---------------------
-- * 6/12/23.	wmk.	original code; adapted from ReportDiffs.
-- * Legacy mods.
...
.mode csv
.separator "|"
.output '$codebase/Projects-Geany/DNCMgr/DNCLog.csv'
select * FROM DNCLog; 
.quit
