-- AvenidaEstanciasTidy.sql - Complete fields in RU-Special/AvenidaEstancias.sql.
-- *	6/1/22.	wmk.
-- *
...
-- * 12/7/21.	wmk.	edited for avenida estancias; NOTE the street name is avenida
-- *					estancia (not estancias).
-- *
-- * Notes. The record date fields will be set to 2021-11-08, matching the .csv
-- * download date.
-- *;

.open '$pathbase/RawData/RefUSA/RefUSA-Downloads/Special/AvenidaEstancias.db'
...
FROM Terr86777
  WHERE "situs address (property address)" like '%avenida estancia%')
