...
-- * 3/19/22.	wmk.	manually edited for SCPA_02-05.db, SCPA_03-19.db
-- *			 Data0205, Data0319.
#
...
.cd '/home/vncwmk3/Territories/RawData/SCPA/SCPA-Downloads'
...
INSERT OR IGNORE INTO Diff0319
 SELECT Data0319.* FROM db15.Data0319
   INNER JOIN db14.Data0205
    ON db15.Data0319."Account#" = db14.Data0205."Account#"
   INNER JOIN db8.AcctsNVen
    ON db15.Data0319."Account#" = db8.AcctsNVen."Account"
	WHERE db15.Data0319."LastSaleDate" <> db14.Data0205."LastSaleDate"
	    OR db15.Data0319."HomesteadExemption(YESORNO)"
