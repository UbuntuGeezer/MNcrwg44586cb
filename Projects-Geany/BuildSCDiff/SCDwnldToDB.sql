...
-- * Dependencies.
-- * -------------
-- * DoSed.sh replaces 05 26 in this file with m2 d2 of the newest
-- *  download data.
-- *
-- * Environment vars - 
...
-- *	($)folderbase/Territories/RawData/SCPA/SCPA-Downloads/Data0526.csv
-- *	  lastest download data from SCPA-Public_05-26.xlsx
...
.open 'SCPA_05-26.db'
DROP TABLE IF EXISTS Data0526;
.headers ON
.mode csv
.import 'Data0526' Data0526 
.quit
