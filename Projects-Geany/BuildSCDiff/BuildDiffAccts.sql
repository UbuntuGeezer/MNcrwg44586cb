--BuildDiffAccts - Build DiffAccts table in new SCPADiff_mm-dd.db.
-- 	3/19/22.	wmk.
--
...
--.open './SCPA/SCPA-Downloads/SCPADiff_mm-dd.db'
...
-- add PropIDs to DiffAccts table;
 WITH a AS (SELECT DISTINCT "Account#",'' from Diff0205)
...
.quit
--*****************************************************;
.cd '$pathbase/Projects-Geany/BuildSCDiff'
