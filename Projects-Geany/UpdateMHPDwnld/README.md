README - UpdateMHPDwnld project documentation.<br>
6/7/22.	wmk.
...
NOTE: The BuildBridges project has a utility to regenerate the Terrxxx\_SC.db
database with pseudo SCBridge records corresponing to the MHP records
in Terryyy\_RU.db.<br><a href="#IX">Index</a>
...
<h3 id="3.0">3.0 Build Processes.</h3>
...
The primary target for MakeUpdateMHPDwnld is the Mapxxx\_RU.csv file.
MapxxRU.csv will be considered out-of-date if the RH< mhp-name >_mm-dd.db
file is newer. MakeUpdateMHPDwnld creates anew the Mapxxx\_RU.csv by
