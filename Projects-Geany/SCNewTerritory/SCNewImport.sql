...
-- *		SCPA-Downloads/Terr807/Full807_SC.csv contains "full" records to be
-- *		 added to Terr86777.db
-- *
-- * Exit.	Terr86777.db updated with records from Full807_SC.csv data
-- *
...
ATTACH '$pathbase/RawData/SCPA/SCPA-Downloads'
 || '/SCPA_04-04.db'
 AS db15;
-- pragma db15.table_info(Data0404);
...
.mode csv
.headers off
.import '$pathbase/RawData/SCPA/SCPA-Downloads/Terr807/Full807_SC.csv' NewImport
...
SELECT "Account#" , Owner1 , Owner2 , Owner3 , MailingAddress1 ,
 MailingAddress2 , MailingCity , MailingState , MailingZipCode ,
  ...
  ValueDataSource , ParcelCharacteristicsData , Status, '2023-04-04'
FROM NewImport;
