...
echo "-- * 4/4/23.	wmk."  >> SQLTemp.sql
echo "-- *"  >> SQLTemp.sql
echo "-- * Modification History."  >> SQLTemp.sql
echo "-- *---------------------"  >> SQLTemp.sql
echo "-- * 4/26/22.   wmk.    *pathbase* support."  >> SQLTemp.sql
echo "-- * 4/4/23.	wmk.	separator set to |."  >> SQLTemp.sql
...
echo ".open 'SCPA_05-28.db'"  >> SQLTemp.sql
echo "DROP TABLE IF EXISTS Data0528;"  >> SQLTemp.sql
echo "CREATE TABLE Data0528 "  >> SQLTemp.sql
...
echo ".import '$pathbase/RawData/SCPA/SCPA-Downloads/Data0528.csv' Data0528"  >> SQLTemp.sql
echo "-- add DownloadDate column for convenient updating NVenAll;"  >> SQLTemp.sql
echo "ALTER TABLE Data0528 ADD COLUMN DownloadDate;"  >> SQLTemp.sql
echo "UPDATE Data0528"  >> SQLTemp.sql
