...
-- * 5/17/23.	wmk.	target path corrected to use *codebase; CntyDate field
-- * 			 added to report; column order changed to place dates in
-- *			 proximity.
-- * 5/18/23.	wmk.	pseudo edit to placate *git.
...
.headers on
.separator ,
.output '$codebase/Projects-Geany/DoTerrsWithCalc/Tracking/DNCDetail.csv'
