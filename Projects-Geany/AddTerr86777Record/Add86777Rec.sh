#!/bin/bash
echo " ** Add86777Rec.sh out-of-date **";exit 1
echo " ** Add86777Rec.sh out-of-date **";exit 1
#hdrAnySQL.sh - Any .sql to .sh shell source.
# 12/12/22.	wmk.
#	Usage. bash Add86777Rec.sh
#		
# Dependencies.
...
if [ -z "$system_log" ]; then
  ...
  ~/sysprocs/LOGMSG "  Add86777Rec - initiated from Make"
  echo "  Add86777Rec - initiated from Make"
else
  ~/sysprocs/LOGMSG "  Add86777Rec - initiated from Terminal"
  echo "  Add86777Rec - initiated from Terminal"
fi 
TEMP_PATH=$HOME/temp
#	Environment vars:
if [ -z "$TODAY" ];then
...
sqlite3 < SQLTemp.sql
echo "  Add86777Rec complete."
~/sysprocs/LOGMSG "  Add86777Rec complete."
#end proc
