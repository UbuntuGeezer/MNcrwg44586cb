...
-- *			 db15.SCPA_02-05.db eliminated from queries.
-- *
...
-- *		Diff0205 - table of differences new/updated SCPA records
...
-- * 6/26/21.	wmk.	multihost code co02ented; ensure proper refs
-- * 					to Diff field names.
-- * 11/3/21.	wmk.	total rewrite.
-- * 12/3/21.	wmk.	DiffAcct field corrected to PropID.
-- * 2/9/22.	wmk.	DelFlag test bug fix; NVenAll qualified with db2;
...
.open '/home/vncwmk3/Territories/DB-Dev/junk.db'

-- move to DiffsToNVenAll.psq...
-- * Update NVenAll with Diff1102 differences;
attach '/home/vncwmk3/Territories/RawData/SCPA/SCPA-Downloads'
|| '/SCPADiff_02-05.db'
as db14;
attach '/home/vncwmk3/Territories/DB-Dev'
|| '/VeniceNTerritory.db'
as db2;
