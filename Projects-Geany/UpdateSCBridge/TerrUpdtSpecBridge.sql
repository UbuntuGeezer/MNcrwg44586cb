-- * TerrUpdtSpecBridge.psq/sql - Update Spec141_SC Bridge table for territory 141.
-- *	12/26/22.	wmk.
-- *
...
-- * 5/28/22.	wmk.	added code to build Diff0528 within Terrxxx_SCdb
...
-- * subquery list.
-- * --------------
-- * TerrUpdtSpecBridge - Update SC Bridge table for territory 141.
-- *;
...
-- *	Spec141_SC.db - as db11, new territory records from SCPA polygon
...
ATTACH '$pathbase'
 ||		'/RawData/SCPA/SCPA-Downloads/Terr141/Spec141_SC.db'
  AS db11;
--  PRAGMA db11.table_info(Spec_SCBridge);
--  PRAGMA db11.table_info(Diffs0528);

-- * create and populate Diffs0528 from SCPADiff_05-28.db.Diffs0528 for
-- * this territory;
