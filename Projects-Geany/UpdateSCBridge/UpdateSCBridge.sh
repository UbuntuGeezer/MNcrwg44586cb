#!/bin/bash
echo " ** UpdateSCBridge.sh out-of-date **";exit 1
...
echo "-- * UpdateSCBridge.psq/sql - Update SC Bridge table for territory 141."  > SQLTemp.sql
...
echo "-- * 5/28/22.	wmk.	added code to build Diff0528 within Terr141_SCdb"  >> SQLTemp.sql
echo "-- *			 since it was missing in 0426 and 0526 builds."  >> SQLTemp.sql
echo "-- * Legacy mods."  >> SQLTemp.sql
echo "-- * 11/3/21.	Total rewrite; change to use Diffsmmd within Terr141_SC.db"  >> SQLTemp.sql
echo "-- *			containing change records; Integrate change records fields"  >> SQLTemp.sql
echo "-- *			into Terr141_SCBridge;"  >> SQLTemp.sql
echo "-- * Legacy mods."  >> SQLTemp.sql
...
echo "-- * --------------"  >> SQLTemp.sql
echo "-- * UpdateSCBridge - Update SC Bridge table for territory 141."  >> SQLTemp.sql
echo "-- *;"  >> SQLTemp.sql
echo ""  >> SQLTemp.sql
...
echo "-- *	Terr141_SC.db - as db11, new territory records from SCPA polygon"  >> SQLTemp.sql
echo "-- *		Terr141_SCBridge - Bridge formatted records extracted from SCPA"  >> SQLTemp.sql
echo "-- *			for territory 141"  >> SQLTemp.sql
...
echo ""  >> SQLTemp.sql
echo "ATTACH '$pathbase'"  >> SQLTemp.sql
echo " ||		'/RawData/SCPA/SCPA-Downloads/Terr141/Terr141_SC.db'"  >> SQLTemp.sql
echo "  AS db11;"  >> SQLTemp.sql
echo "--  PRAGMA db11.table_info(Terr141_SCBridge);"  >> SQLTemp.sql
echo "--  PRAGMA db11.table_info(Diffs0528);"  >> SQLTemp.sql
echo ""  >> SQLTemp.sql
echo "-- * create and populate Diffs0528 from SCPADiff_05-DD.db.Diffs05DD for"  >> SQLTemp.sql
...
echo " FROM db11.Terr141_SCBridge)"  >> SQLTemp.sql
echo "INSERT OR REPLACE INTO db11.Diffs0528"  >> SQLTemp.sql
...
echo "  FROM db11.Diffs0528 )"  >> SQLTemp.sql
echo "UPDATE db11.Terr141_SCBridge"  >> SQLTemp.sql
