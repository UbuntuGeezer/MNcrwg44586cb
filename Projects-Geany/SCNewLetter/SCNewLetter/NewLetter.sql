...
-- *			table Lett641_TS replacing unnamed field before City.
-- * 10/22/21.	bug fix DROP TABLE Lett641_TS was incorrect.
-- *
-- * Notes. NewLetter.psq is transformed into NewLetter.sql by DoSed.sh
-- * NewLetter.sql performs the following operations:
-- *	open a new database SCPA-Downloads/Terr641/Terr641_SC.db
-- *	create table Terr641_SCPoly with fields matching SCPA polygon download
...
.open '/media/ubuntu/Windows/Users/Bill/Territories/RawData/SCPA/SCPA-Downloads/Terr641/Terr641_SC.db'
DROP TABLE IF EXISTS Terr641_SCPoly;
CREATE TABLE Terr641_SCPoly 
...
LOCATIONCITY TEXT, LOCATIONZIP TEXT);
 -- import Lett641_TS.csv into Terr641_SC.db.Terr641_TSRaw;
DROP TABLE IF EXISTS Lett641_TS;
CREATE TABLE Lett641_TS
(AreaName TEXT, HouseNumber TEXT, Street1 TEXT, Street2 TEXT,
 Street3 TEXT, Unit TEXT, City TEXT, Empty TEXT, State TEXT, Zip TEXT );
.headers ON
.mode csv
.separator ,
.import '/media/ubuntu/Windows/Users/Bill/Territories/RawData/SCPA/SCPA-Downloads/Terr641/Lett641_TS.csv' Lett641_TS
DROP TABLE IF EXISTS Terr641_TSRaw;
ALTER TABLE Lett641_TS RENAME TO Terr641_TSRaw;
-- now populate Terr641_SCPoly with data from Terr641_TSRaw;
INSERT INTO Terr641_SCPoly
SELECT '', '', '', '', '',
 '', '', '',HouseNumber, 
 ...
 DROP TABLE IF EXISTS Terr641_SCBridge;
CREATE TABLE Terr641_SCBridge
...
SELECT '-', StreetAddr,
  ...
  '', '', ''
FROM a;
-- now select all the records just created and make a pseudo Map641_SC.csv;
-- this .csv will be used in the unlikely event that SCNewTerritory gets run
-- so there is a .csv file to pick up..;
.headers ON
.mode csv
.separator ,
.output '/media/ubuntu/Windows/Users/Bill/Territories/RawData/SCPA/SCPA-Downloads/Terr641/Map641_SC.csv'
select * from Terr641_SCPoly;

-- now set OwningParcel, Resident1, SitusAddress, PropUse, and RecordType from
-- TerritoryNVenice. NVenAll and SCPropUse tables;
ATTACH '/media/ubuntu/Windows/Users/Bill/Territories/DB-Dev/VeniceNTerritory.db'
 AS db2;
...
WITH a AS (SELECT "Account #" AS Acct,
 ...
 WHERE StreetAddr IN (SELECT UPPER(TRIM(UnitAddress))
  FROM Terr641_SCBridge) )
UPDATE Terr641_SCBridge
SET OwningParcel =
CASE 
...
;
-- *;
-- Attach TerrIDData.db and extract Terr641Hdr.csv, saving into folder
--  TerrData/Terr641/Working-Files;
...
.mode csv
.separator ,
.output '/media/ubuntu/Windows/Users/Bill/Territories/TerrData/Terr641/Working-Files/Terr641Hdr.csv'
SELECT * FROM db4.Territory
WHERE TerrID is '641';	
.quit

--**************************************************************************;
.open /media/ubuntu/Windows/Users/Bill/Territories/RefUSA/RefUSA-Downloads/Terr641/Terr641_RU.db'
CREATE TABLE Terr641_RUPoly ("Last Name" TEXT,"First Name" TEXT,
 ...
 "Phone Number" TEXT);
 -- import Lett641_TS.csv into Terr641.db.Terr641_TSRaw;
.import '/media/ubuntu/Windows/Users/Bill/Territories/RefUSA/RefUSA-Downloads/Terr641/Lett641_TS.csv' Terr641_TSRaw
-- now populate Terr641_RUPoly with data from Terr641_TSRaw;
INSERT INTO Terr641_RUPoly
