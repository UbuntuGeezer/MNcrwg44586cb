...
vpath %.db $(pathbase)/Biz/RawData/RefUSA/RefUSA-Downloads/Terrxxx
vpath %.csv $(pathbase)/Biz/RawData/RefUSA/RefUSA-Downloads/Terrxxx
vpath %.sql $(pathbase)/Biz/RawData/RefUSA/RefUSA-Downloads/Terrxxx
bashpath = $(pathbase)/Procs-Dev
prepath = $(pathbase)/Biz/RawData/RefUSA/RefUSA-Downloads/Terrxxx
postpath = $(pathbase)/Biz/RawData/RefUSA/RefUSA-Downloads/Terrxxx
